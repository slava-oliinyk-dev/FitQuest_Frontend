			...
			<Modal isVisible={isVisible} onClose={handleClose}>
				<div className="main__modal">
					...
					<p className="main__modal-text">
						We use cookies to ensure a secure and seamless experience on our website. Our site uses only essential cookies for user authentication (e.g., storing a session token) and maintaining site
						stability. By clicking “Accept,” you consent to our use of these cookies. For more details about the cookies we use and how we handle your data, please review our{' '}
						<a className="main__modal-link" href="/privacy" target="_blank" rel="noopener noreferrer">
							Privacy Policy
						</a>
						.{' '}
					</p>
					<button className="main__modal-button" onClick={handleAccept}>
						I agree
					</button>
