    ...
    return (
        <nav className='nav'>
            <div className="nav__wrapper">
                <a href="#"><HashLink smooth to="/#main-screen"><img className="nav__logo" src={logo} alt="logo" /></HashLink></a>
                {!isOpen && (
                    <button
                ...
                <ul className={`nav__list ${isOpen ? 'nav__list--open' : ''}`}>
                    ...
                    <li onClick={toggleMenu}><button className="nav__button--mobile" onClick={handleButtonClick}>
