    ...
    return <div className='contact' id='contact'>
        ...
        <div className='contact__content'>
            <div className='contact__forms'>
                ...
                <textarea
                    className="contact__input contact__input-question"
                ...
                <Modal className='modal__contact' isVisible={isModalVisible} onClose={closeModal}>
                    <div>
                        ...
                        <button className='modal__contact-button' onClick={closeModal}>Close</button>
                    </div>
                </Modal>
                {errorMessage && (
            ...
            <picture>
                <source
                    ...
                    srcSet={`${contact560} 1x, ${contact560x2} 2x`}
                />
                <source
                    media="(max-width: 1060px)"
                    srcSet={`${contact420} 1x, ${contact420x2} 2x`}
                />
                <source
                    media="(max-width: 1250px)"
                    srcSet={`${contact500} 1x, ${contact500x2} 2x`}
                />
                <img
