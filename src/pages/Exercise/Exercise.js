            ...
            <div className='exercise__main'>
                ...
                <Modal isVisible={isModalVisible} onClose={closeModal}>
                    ...
                    <div className='exercise-modal__inputs'>
                        <div className='exercise-modal__inputs-input-label'><input className='exercise-modal__inputs-input' value={exerciseData.sets} name="sets" type="text" inputMode="numeric" placeholder='0' onChange={handleNumberInputChange} />
                            <label htmlFor="sets">sets</label></div>
                        <div className='exercise-modal__inputs-input-label'><input className='exercise-modal__inputs-input' value={exerciseData.weight} name="weight" type="text" inputMode="numeric" placeholder='0' onChange={handleNumberInputChange} />
                            <label htmlFor="kg">kg</label></div>
                        <div className='exercise-modal__inputs-input-label'><input className='exercise-modal__inputs-input' value={exerciseData.reps} name="reps" type="text" inputMode="numeric" placeholder='0' onChange={handleNumberInputChange} />
                            <label htmlFor="reps">reps</label></div>
                    </div>
                    {errorMessage && (
                        <p className="exercise__modal-error">{errorMessage}</p>
                    )}
