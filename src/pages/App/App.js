		...
		<div className="app">
			...
			<div className="app__main">
				...
				{selectedMenuItemId === 1 &&
					(selectedDayCardId ? (
						<Exercise selectedDayCardId={selectedDayCardId} selectedExerciseCardId={selectedExerciseCardId} setSelectedExerciseCardId={setSelectedExerciseCardId} />
					) : selectedProgramCardId ? (
						<Day selectedProgramCardId={selectedProgramCardId} setSelectedProgramCardId={setSelectedProgramCardId} onDayCardSelect={setSelectedDayCardId} />
					) : (
						<Program onProgramCardSelect={setSelectedProgramCardId} />
					))}
				{(selectedMenuItemId === 2 || selectedMenuItemId === 3 || selectedMenuItemId === 4) && <Later />}
			</div>
		</div>
	);
}
