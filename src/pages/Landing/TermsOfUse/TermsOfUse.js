		...
		<div className="terms">
			...
			<div className="terms__content">
				...
				<span className="terms__text">
					...
					<br />
					<br />
					<span className="terms__subtitle">2) Data Collection and Processing</span>
					<br />
					...
					<br />
					<br />
					<span className="terms__subtitle">3) Cookies and Session Data</span>
					<br />
					...
					<br />
					<br />
					<span className="terms__subtitle">4) Hosting and Third-Party Services</span>
					<br />
					...
					<br />
					<br />
					<span className="terms__subtitle">5) Data Retention</span>
					<br />
					...
					<br />
					<br />
					<span className="terms__subtitle">6) Rights of the Data Subject</span>
					<br />
